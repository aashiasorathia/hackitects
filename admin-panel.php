...
function generate_bill(){
  ...
  while($row = mysqli_fetch_array($query)){
    ...
    <label> Month of pregnancy : </label>'.$row["disease"].'<br/><br/>
    <label> Problems faced : </label>'.$row["allergy"].'<br/><br/>
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center">MaternaSage</h2></br>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Ratings</a>
    </div><br>
  </div>
            ...
            <div class="card-body">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-4"><label>Number of visit </label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="appcount"></div><br><br>
                  <div class="col-md-4">
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Appointment Date</th>
                    <th scope="col">Appointment Time</th>
                    <th scope="col">Month of Pregnancy</th>
                    <th scope="col">Problems faced</th>
