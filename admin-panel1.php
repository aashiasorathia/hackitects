  ...
  <head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css" integrity="sha384-/Y6pD6FV/Vv2HJnA6t+vslU6fwYXjCFtcEpHbNJ0lyAFsXTsjBbfaDjzALeQsN6M" crossorigin="anonymous">
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        ...
        <a class="navbar-brand" href="#"><img src="images/pngwing.com.png" width="70px" alt="" />&nbsp MaternaSage</a>
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
      ...
      <li style="padding-left: 1300px;">
                    <div style="margin: right 20px;" class="language-container" ;>
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-nurse" id="list-nurse-list"  role="tab" data-toggle="list" aria-controls="home">Nurse List</a>
               ...
               <div class="col-sm-4">
                ...
                <div class="col-sm-4" style="margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Nurses List</h4>
                    
                      <p class="cl-effect-1">
                        <a href="#list-nurse" onclick="clickDiv('#list-nurse-list')">
                          View Nurses
                        </a>
                      </p>
                    </div>
                ...
                <div class="row">
                <div class="col-sm-4" style="left: 16%;margin-top: 10%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                ...
                <div class="col-sm-4" style="left: 60%;margin-top: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
...
<div class="tab-pane fade" id="list-nurse" role="tabpanel" aria-labelledby="list-nurse-list">
      
<div class="col-md-8">
      <form class="form-group" action="nursesearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="nurse_contact" placeholder="Enter Email ID" class = "form-control"></div>
              ...
              <table class="table table-hover">
                <thead>
                  ...
                  <th scope="col">Doctor</th>
                    ...
                    <th scope="col">Problems faced(if any)</th>
          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="General" name="spec">General Checkup Specialist</option>
                      <option value="Cardiologist" name="spec">Obstetrics and Gynecology</option>
                      <option value="Neurologist" name="spec">Reproductive Endocrinologist</option>
                      <option value="Pediatrician" name="spec">Urogynecologist</option>
                    </select>
                    </div><br><br>
