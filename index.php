...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><img src="images/pngwing.com.png" width="70px" alt=""/>&nbsp MaternaSage</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-5" style="right: 5%; display: block; margin-left: 40%; margin-right: 50%;">
                        <img src="https://cdni.iconscout.com/illustration/premium/thumb/pregnant-woman-4385448-3649296.png" alt="" style="width:80%"/>
                        <h3 style="color:white; padding: 50px;margin-top:-1%; margin-left: 60px">WELCOME</h3>
                       
                    </div>
                    <div class="col-md-12" style="margin-top: 40px;left: 80px; background-color:#f8f9fa;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Doctor Login</h3>
                    ...
                    <div><b><p style="color:white; margin-top:20px; margin-left:950px;">Created by Team738</p></b></div>
                </div>
