...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><img src="images/pngwing.png" alt=""/>&nbsp MaternaSage</a>
...
<body style="padding-top:50px;">
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          ...
          <div class="row">
                  <div class="col-md-4"><label>Month of Pregnancy :</label></div>
                  <div class="col-md-8">
                  <!-- <input type="text" class="form-control" name="disease" required> -->
                  <textarea id="disease" cols="86" rows ="5" name="disease" required></textarea>
                  </div><br><br><br>
                  
                  <div class="col-md-4"><label>Problems faced if any:</label></div>
                  <div class="col-md-8">
